...
class Backend {
  ...
  initTanStackBackend() {
    // TanStack Query backend initialization is handled externally
    // See: lib/tanstack-backend.js for the enhanced backend
    // This maintains backward compatibility while keeping the core lightweight
    this.tanstackBackend = null
  }
